...
class HubspotClient(HttpClientBase):
    ...
    def get_companies(self, recent=False, fields=None):
        ...
        if recent:
            return self._get_paged_result_pages(
                COMPANIES_RECENT, parameters, "results", "count", "offset", "offset", "hasMore", offset, 200
            )
        else:
            return self._get_paged_result_pages(
                COMPANIES_ALL, parameters, "companies", "limit", "offset", "offset", "has-more", offset, 250
            )
    ...
    def get_deals(self, start_time=None, fields=None) -> Iterable:
        ...
        if start_time:
            ...
            return self._get_paged_result_pages(
                DEALS_RECENT, parameters, "results", "count", "offset", "offset", "hasMore", offset, 100
            )
        else:
            return self._get_paged_result_pages(
                DEALS_ALL, parameters, "deals", "limit", "offset", "offset", "hasMore", offset, 250
            )
