ENDPOINT_MAPPING = {
    "contact_create": {"endpoint": "crm/v3/objects/contacts/batch/create", "required_column": [], "method": "post"},
    "list_create": {"endpoint": "contacts/v1/lists", "required_column": ["name"], "method": "post"},
    "custom_list_create": {"endpoint": "crm/v3/lists", "required_column": ["name", "object_type"], "method": "post"},
    "custom_object_create": {"endpoint": "crm/v3/objects/{object_type}", "required_column": [], "method": "post"},
    "contact_add_to_list": {
    ...
    "deal_update": {"endpoint": "crm/v3/objects/deals/batch/update", "required_column": ["deal_id"], "method": "post"},
    "deal_remove": {"endpoint": "crm/v3/objects/deals/batch/archive", "required_column": ["deal_id"], "method": "post"},
    "deal_add_to_list": {
        "endpoint": "crm/v3/lists/{list_id}/memberships/add-and-remove",
        "required_column": ["list_id", "vids"],
        "method": "put",
    ...
    "tax_update": {"endpoint": "crm/v3/objects/taxes/batch/update", "required_column": ["tax_id"], "method": "post"},
    "tax_remove": {"endpoint": "crm/v3/objects/taxes/batch/archive", "required_column": ["tax_id"], "method": "post"},
    "call_create": {
        "endpoint": "crm/v3/objects/calls/batch/create",
        "required_column": ["association_id", "association_category", "association_type_id"],
        "method": "post",
    },
    "call_update": {"endpoint": "crm/v3/objects/calls/batch/update", "required_column": ["call_id"], "method": "post"},
    "call_remove": {"endpoint": "crm/v3/objects/calls/batch/archive", "required_column": ["call_id"], "method": "post"},
    ...
    "note_update": {"endpoint": "crm/v3/objects/notes/batch/update", "required_column": ["note_id"], "method": "post"},
    "note_remove": {"endpoint": "crm/v3/objects/notes/batch/archive", "required_column": ["note_id"], "method": "post"},
    "postal_mail_create": {
    ...
    "task_update": {"endpoint": "crm/v3/objects/tasks/batch/update", "required_column": ["task_id"], "method": "post"},
    "task_remove": {"endpoint": "crm/v3/objects/tasks/batch/archive", "required_column": ["task_id"], "method": "post"},
    "association_create": {
...
LEGACY_ENDPOINT_MAPPING_CONVERSION = {
